...
In fact, this time, it was not a tab-cleanup day, instead, it was a couple of days where I categorised all the papers I've collected in my tabs into concepts, ending up reading some papers fully and some partially, trying to decide on what to work on next on my third year. The issue is, research is progressing exponentially and I have been thinking on some ideas, and come across to a couple of them already appeared in arxiv in December. Struggling with this reality, I somehow aim to sort topics and technical developments into their importance (from my point of view and only what I think is interesting). 

Here are some headlines and a curated list of papers, you can also check on github directly [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
...
#### Applications in 2D downstream tasks, surgery
...
- [Object detection](https://arxiv.org/pdf/2211.09788.pdf https://github.com/ShoufaChen/DiffusionDet) 
...
- [PointE](https://github.com/openai/point-e](https://arxiv.org/pdf/2212.08751.pdf)
